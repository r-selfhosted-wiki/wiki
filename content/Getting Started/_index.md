...
- [Hosting a website]({{< ref "website-hosting.md" >}} "Hosting a website" )
...
- [What are the easiest and typical ways I can self host?]({{< ref "how-to-self-host.md" >}} "Self-hosted how-to ")
